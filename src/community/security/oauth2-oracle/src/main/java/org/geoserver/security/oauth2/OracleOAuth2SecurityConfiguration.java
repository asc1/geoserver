 ...
 */
@Configuration(value = "oracleOAuth2SecurityConfiguration")
@EnableOAuth2Client
class OracleOAuth2SecurityConfiguration extends GeoServerOAuth2SecurityConfiguration {

    @Bean(name = "oracleOAuth2Resource")
    ...
    @Bean(name = "oracleOauth2RestTemplate")
